...
def main(argv):
    if len(argv) < 8:
        print("Usage: rosrun pinhandling_state_publisher ur_ee_coordinate_publisher.py <orientation_x> <orientation_y> <orientation_z> <orientation_w> <pos_x> <pos_y> <pos_z>")
        return
