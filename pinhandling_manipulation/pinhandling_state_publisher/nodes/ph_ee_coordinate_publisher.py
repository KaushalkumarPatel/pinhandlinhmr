...
class EEPositionPublisherNode:
    """
    The Pinhandling End Effector Position Publisher
    """
    ...
    def publish_position(self):
        ...
        achieved_orientation_x = wpose.orientation.x
        achieved_orientation_y = wpose.orientation.y
        achieved_orientation_z = wpose.orientation.z
        achieved_orientation_w = wpose.orientation.w
        achieved_position_x = wpose.position.x
        achieved_position_y = wpose.position.y
        achieved_position_z = wpose.position.z
