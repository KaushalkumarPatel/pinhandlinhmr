...
class EETrajectoryCalculatorNode:
    ...
    def __init__(self):
        rospy.init_node("trajectory_planner_bs_close_server")

        service = rospy.Service('cartesian_path_bs_close',    # service name
    ...
    def calculate_trajectory(self, req):
        ...
        firsteedegree = math.radians(-225)
...
def main():
    print("Ready to calculate cartesian trajectory for backside close of the pin")
