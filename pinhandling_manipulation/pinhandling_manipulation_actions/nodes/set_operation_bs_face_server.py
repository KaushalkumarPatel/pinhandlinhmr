...
class SetOperationBSFacePositionServer():
    ...
    def publish_position(self, goal):
        ...
        if goal:
            ...
            self.move_group.set_named_target('operation_ready_bs_face')
...
if __name__ == '__main__':
    rospy.init_node('set_operation_bs_face_position_action')
    server = SetOperationBSFacePositionServer(rospy.get_name())
    rospy.spin()