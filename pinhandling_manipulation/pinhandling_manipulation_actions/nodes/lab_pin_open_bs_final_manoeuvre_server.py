...
class PinOpenBSFinalManoeuvreActionServer():
    ...
    def publish_position(self, goal):
        ...
        if goal:
            ...
            pose_goal.position.z = resp1.trajectory[len(resp1.trajectory) - 1] + 0.1
...
if __name__ == '__main__':
    rospy.init_node('pin_open_bs_last_manoeuvre_action')
    server = PinOpenBSFinalManoeuvreActionServer(rospy.get_name())
    rospy.spin()