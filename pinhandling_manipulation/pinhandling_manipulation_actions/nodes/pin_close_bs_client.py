...
def pin_close_bs_client():
    ...
    client = actionlib.SimpleActionClient('set_operation_position_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
    ...
    client3 = actionlib.SimpleActionClient('set_operation_position_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
