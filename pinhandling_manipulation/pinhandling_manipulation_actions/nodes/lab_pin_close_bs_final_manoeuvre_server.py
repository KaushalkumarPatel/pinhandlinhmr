...
class PinCloseBSFinalManoeuvreActionServer():
    ...
    def publish_position(self, goal):
        ...
        if goal:
            ...
            pose_goal.position.x = resp1.trajectory[len(resp1.trajectory) - 3] 
            pose_goal.position.y = resp1.trajectory[len(resp1.trajectory) - 2] - 0.2
...
if __name__ == '__main__':
    rospy.init_node('pin_close_bs_last_manoeuvre_action')
    server = PinCloseBSFinalManoeuvreActionServer(rospy.get_name())
    rospy.spin()