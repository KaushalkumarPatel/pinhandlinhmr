...
class PinCloseBSLinearMotionActionServer():
    ...
    def publish_position(self, goal):
        ...
        if goal:
            ...
            pose_goal.position.y = resp1.trajectory[len(resp1.trajectory) - 2] - 0.1
...
if __name__ == '__main__':
    rospy.init_node('pin_close_bs_linear_motion_action')
    server = PinCloseBSLinearMotionActionServer(rospy.get_name())
    rospy.spin()