...
def pin_open_bs_client():
    ...
    while client_threshold != 'True':
        ...
        client = actionlib.SimpleActionClient('set_operation_bs_position_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
        ...
        rospy.loginfo("Sending arm to grasping position from backside of the pin")
        # Creates the SimpleActionClient, passing the type of the action
        # (ee_coordinateAction) to the constructor.
        client1 = actionlib.SimpleActionClient('pin_open_bs_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
    ...
    client3 = actionlib.SimpleActionClient('pin_open_bs_last_manoeuvre_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
