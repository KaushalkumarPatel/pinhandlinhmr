...
def pin_close_bs_client():
    ...
    while client_threshold != 'True':
        ...
        packet = b"\x00\x01\x00\x00\x00\x06\x00\x06\x00\x80\x00\x00"  # Write single register (coil) at address 128 with value 0
        ...
        # Set the robot arm to operation ready mode
        client = actionlib.SimpleActionClient('set_operation_bs_close_position_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
        ...
        client1 = actionlib.SimpleActionClient('pin_close_bs_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
        ...
        client2 = actionlib.SimpleActionClient('pin_close_bs_traj_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
    ...
    rospy.loginfo("Starting Linear Motion")
    # Moving ee to escape from the pin
    client2 = actionlib.SimpleActionClient('pin_close_bs_linear_motion_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
    ...
    # Moving ee to escape from the pin
    client3 = actionlib.SimpleActionClient('pin_close_bs_last_manoeuvre_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
    ...
    rospy.loginfo("Setting arm to 'operation ready' pose")
    client4 = actionlib.SimpleActionClient('set_operation_bs_position_action', pinhandling_manipulation_actions.msg.PinOpenCloseBsAction)
...
if __name__ == '__main__':
    try:
        ...
        rospy.init_node('pin_close_bs_client_py')
        result = pin_close_bs_client()
