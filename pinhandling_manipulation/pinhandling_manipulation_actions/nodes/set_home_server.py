...
class SetHomePositionServer():
    ...
    def publish_position(self, goal):
        ...
        if goal:
            ...
            print("Setting the arm to the Home position")
            ...
            rospy.loginfo('\n%s: Executing, set home poisition server'
                        % self._action_name)
...
if __name__ == '__main__':
    rospy.init_node('set_home_position_action')
    server = SetHomePositionServer(rospy.get_name())
    rospy.spin()